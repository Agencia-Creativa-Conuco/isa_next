  ...
  const data = [
    {
      ...
      area:
        'Circulación y préstamos de colecciones general, de referencia y reserva',
    ...
    },
    {
      ...
      area:
        'Uso de computadora con acceso a internet, escáneres e impresión de documentos',
      horaryTitle: 'LUNES A VIERNES',
          ...
          {data.map((data, index) => {
            ...
            return (
              <ScheduleContainer key={index}>
                ...
                <ScheduleTitle>{horaryTitle}</ScheduleTitle>
                <Schedule>{horarySchedule}</Schedule>

                <ScheduleTitle>{OtherScheduleTitle}</ScheduleTitle>
